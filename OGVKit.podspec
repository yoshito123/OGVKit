Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/yoshito123/OGVKit.git",
                     :tag => s.version,
                     :submodules => true }
  ...
  s.subspec "TheoraDecoder" do |stheoradecoder|
    stheoradecoder.xcconfig = { 'OTHER_CFLAGS' => '-DOGVKIT_HAVE_THEORA_DECODER=1' }
    stheoradecoder.dependency 'OGVKit/Core'
    stheoradecoder.dependency 'libtheora', '1.2.0-3'
  end
  s.subspec "VP8Decoder" do |svp8decoder|
    svp8decoder.xcconfig = { 'OTHER_CFLAGS' => '-DOGVKIT_HAVE_VP8_DECODER=1' }
  ...
  s.subspec "VorbisDecoder" do |svorbisdecoder|
    svorbisdecoder.xcconfig = { 'OTHER_CFLAGS' => '-DOGVKIT_HAVE_VORBIS_DECODER=1' }
    svorbisdecoder.dependency 'OGVKit/Core'
    svorbisdecoder.dependency 'libvorbis'
  end
  s.subspec "OpusDecoder" do |sopusdecoder|
    sopusdecoder.xcconfig = { 'OTHER_CFLAGS' => '-DOGVKIT_HAVE_OPUS_DECODER=1'  }
  ...
  s.subspec "EncoderCore" do |scoreenc|
    scoreenc.xcconfig = { 'OTHER_CFLAGS' => '-DOGVKIT_HAVE_ENCODER=1' }
  ...
  s.subspec "VorbisEncoder" do |svorbisenc|
    svorbisenc.xcconfig = { 'OTHER_CFLAGS' => '-DOGVKIT_HAVE_VORBIS_ENCODER=1' }
  ...
  s.subspec "VP8Encoder" do |svp8enc|
    svp8enc.xcconfig = { 'OTHER_CFLAGS' => '-DOGVKIT_HAVE_VP8_ENCODER=1' }
  ...
  s.subspec "WebMMuxer" do |swebmmux|
    swebmmux.xcconfig = { 'OTHER_CFLAGS' => '-DOGVKIT_HAVE_WEBM_MUXER=1' }
